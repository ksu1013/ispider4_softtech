 ...
 * @author 김승욱
 */
public class DiaArtGovExtension implements Extension, AddonExtension {
    ...
    public String changeHtml(String htmlSrc, DqPageInfo dqPageInfo) {
        ...
        if (dqPageInfo.getParentUrl() == null){
           ...
           // String domain=commonUtil.getDomain(url);
            ...
            htmlSrc = commonUtil.getUrlList(urlList, "").replace("http","https");
        } else {
            /* 변수선언 start */
            String title = "";
            String content = "";
...
//          //create date
            try {
                datetimeHtml = document.select("meta[itemprop=datePublished]").attr("content");
