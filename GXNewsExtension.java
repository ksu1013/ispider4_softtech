 ...
 *
 */
public class GXNewsExtension implements Extension, AddonExtension {
    /* 테스트용 S */
    ...
    public String changeHtml(String htmlSrc, DqPageInfo dqPageInfo) {
       ...
       try {
           ...
           if(dqPageInfo.getParentUrl() == null) {    // 0depth
               Elements urlList = document.select("#listBox");
               ...
               //create date
               String datetimeHtml = document.select(".pr10").text();
               ...
               //content
               Elements contentHtml = document.select(".article-content");
               contentHtml.select("img").removeAttr("data-save-path").removeAttr("data-domain");
