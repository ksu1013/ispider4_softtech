 ...
 * @author 김승욱
 */
public class CarnegiePolitilkaExtension implements Extension, AddonExtension {
...
//        BbsPage pageContent = Configuration.getInstance().getBbsPage(dqPageInfo.getBbsId(), 1, "*");
    ...
    public String changeHtml(String htmlSrc, DqPageInfo dqPageInfo) {
        ...
        if (dqPageInfo.getParentUrl() == null){
            ...
            urlList = document.select("div[class=col col-33]").select("h2");
          ...
          //  System.out.println("htmlSrc = " + htmlSrc);
            ...
            title=document.select("h1[class=hide-mobile]").text();
            //System.out.println("title = " + title);

            //create date
            try {
                datetimeHtml=document.select("div[class=smaller-text gutter-half-bottom cyrillic-normal-bold pub-date]").text();
            ...
            // content
            Elements contentHtml = document.select("div[class=article-body]");
