 ...
 * @author 전제현
 */
public class CrfNewsExtension implements Extension {
	...
	public void startExtension(DqPageInfo dqPageInfo, String homePath) {
		System.out.println("=== CrfNewsExtension Start ===");
...
//			Elements contentElement = doc.getElementsByClass("content all-txt");
			...
			/* 생성일(created_date) 수집 */
//			String dateElement = doc.getElementsByClass("time fix").text();
			String dateElement = commonUtil.getSubStringResult("<font size=\"3\">", "</font>", htmlSrc);
